...
public class GetCulturon implements Reporter{
	...
	public Object report(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			GroupInstanceScrubber.checkAndUpdateAgentGroupVariables(((double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString()))),
					...
					return myCogScheme.getCulturonValueForGroupInstance((double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString())),
							args[1].getString());
		}
		return 0.0;		
	}
