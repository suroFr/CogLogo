...
public class SetParticipation implements Command{
	...
	public void perform(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			...
			if(myCogScheme.checkGroupTypeExists(args[0].getString())
					&& (double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString())) != -1)
			{
				try {
					t.setVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString())+2, args[1].getDoubleValue());
