...
public class SetCulturon implements Command{
	...
	public void perform(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			...
			myCogScheme.setCulturonValueForGroupInstance((double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString())),
