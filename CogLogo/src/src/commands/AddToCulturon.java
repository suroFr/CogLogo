...
public class AddToCulturon implements Command{

	// group type / culturon name / value
	...
	public void perform(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			...
			myCogScheme.addToCulturonValueForGroupInstance((double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString())),
					args[1].getString(), args[2].getDoubleValue());
		}		
	}
}
