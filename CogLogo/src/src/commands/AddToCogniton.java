...
public class AddToCogniton implements Command{
	...
	public void perform(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			try {
				...
				{
					if(t.getVariable(myCogScheme.getCognitonVariableOffset(breedName,args[0].getString())).getClass() != String.class)
					{
						double oldVar = (double) t.getVariable(myCogScheme.getCognitonVariableOffset(breedName,args[0].getString()));
						t.setVariable(myCogScheme.getCognitonVariableOffset(breedName,args[0].getString()), oldVar + args[1].getDoubleValue());	
					}				
				}else
				{
