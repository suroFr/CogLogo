...
public class CreateAndJoinGroup implements Command{
	...
	public void perform(Argument[] args, Context context) throws ExtensionException {
		...
		if(myCogScheme != null)
		{
			...
			if(myCogScheme.checkGroupRoleTypeExists(args[0].getString(), args[1].getString()) &&((double)t.getVariable(myCogScheme.getGroupVariableOffset(breedName,args[0].getString()))) == -1)
			{
				try {
